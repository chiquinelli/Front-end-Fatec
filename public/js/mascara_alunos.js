...
const __ARR_ID = ["name", "txtEmail", "cboCurso", "txtSenha", "cboSemestre", "txtConfirmaSenha", "txtCpf", "politicas"]
...
// VALIDAÇÃO NOME
const __NAME = document.getElementById('name')
